...
namespace dinner.net.Controllers
{
    public class IngredientController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include="ID,Name,QuantityOnHand,ExtendedDescription")] Ingredient ingredient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include="ID,Name,QuantityOnHand,ExtendedDescription")] Ingredient ingredient)
        {
            if (ModelState.IsValid)
            {
